...
def get_ds(config):
    ds_raw=load_dataset('csv', data_files='data/my_data.csv', split='train')
     

    ds_raw = ds_raw.rename_column("en", config['lang_src'])
    ds_raw = ds_raw.rename_column("mni", config['lang_tgt'])
    #Build tokenizer
